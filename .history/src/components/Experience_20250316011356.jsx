...
export default function Experience({ data }) {
  ...
  return (
    <section className="section experience-section gray-bg">
            ...
            >
              <div className="ex-box">
                <div className="row gy-4">
                  <div className="col-md-4.5 col-lg-3.5">
                    <div className="ex-left">
                      <h4 class="designation">{item.designation}</h4>
                      <span>{item.company}</span>
                      <p>{item.duration}</p>
                      <label>{item.jobType}</label>
                    </div>
                  </div>
                  <div className="col-md-7.5 col-lg-8.5">
